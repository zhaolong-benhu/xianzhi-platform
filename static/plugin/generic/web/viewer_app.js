...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '//f3-xz.veimg.cn/m/plugin/generic/web/images/';
  PDFJS.workerSrc = '//f3-xz.veimg.cn/m/plugin/generic/build/pdf.worker.js';
  PDFJS.cMapUrl = '//f3-xz.veimg.cn/m/plugin/generic/web/cmaps/';
...
var HOSTED_VIEWER_ORIGINS = ['null',
  'http://papers.xz.veimg.cn', 'http://m.9first.com','http://xz.9first.com:8080'];
...
function webViewerInitialized() {
  ...
  //http://api.9first.com/mv1/papers/content/?id=53214
  var file = 'file' in params ? '/api/mv1/papers/content?id='+params.file : DEFAULT_URL;
