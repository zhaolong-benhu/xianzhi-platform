...
(function (webim) {
                ...
                "request_info": [                       // 类型: Array
                    {
                        ...
                        "auth_key": authkey,            // 类型: String, 证书签名
    ...
    var MsgManager = new function () {
        ...
        var onC2cEventCallbacks = null;//c2c消息回调
